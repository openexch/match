...
public final class ClientRegisterEncoder
{
    ...
    private final ClientRegisterEncoder parentMessage = this;
    ...
    public ClientRegisterEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public ClientRegisterEncoder wrapAndApplyHeader(
    ...
    public ClientRegisterEncoder clientId(final long value)
    {
    ...
    public ClientRegisterEncoder clientType(final ClientType value)
    {
