...
public final class UpdateOrderEncoder
{
    ...
    public UpdateOrderEncoder userId(final long value)
    {
    ...
    public UpdateOrderEncoder orderId(final long value)
    {
    ...
    public UpdateOrderEncoder price(final long value)
    {
    ...
    public UpdateOrderEncoder quantity(final long value)
    {
    ...
    public UpdateOrderEncoder marketId(final int value)
    {
