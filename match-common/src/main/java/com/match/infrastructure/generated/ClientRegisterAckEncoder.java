...
public final class ClientRegisterAckEncoder
{
    ...
    private final ClientRegisterAckEncoder parentMessage = this;
    ...
    public ClientRegisterAckEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public ClientRegisterAckEncoder wrapAndApplyHeader(
    ...
    public ClientRegisterAckEncoder clientId(final long value)
    {
    ...
    public ClientRegisterAckEncoder accepted(final short value)
    {
