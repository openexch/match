...
public final class MarketDataSubscribeEncoder
{
    ...
    private final MarketDataSubscribeEncoder parentMessage = this;
    ...
    public MarketDataSubscribeEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public MarketDataSubscribeEncoder wrapAndApplyHeader(
    ...
    public MarketDataSubscribeEncoder marketId(final int value)
    {
