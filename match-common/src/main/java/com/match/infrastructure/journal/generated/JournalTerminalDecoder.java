...
public final class JournalTerminalDecoder
{
    ...
    private final JournalTerminalDecoder parentMessage = this;
    ...
    public JournalTerminalDecoder wrap(
    ...
    public JournalTerminalDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public JournalTerminalDecoder sbeRewind()
    {
    ...
    {
        return TerminalStatus.get(((short)(buffer.getByte(offset + 28) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[JournalTerminal](sbeTemplateId=");
    ...
    public JournalTerminalDecoder sbeSkip()
    {
        sbeRewind();
