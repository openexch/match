...
public final class UpdateOrderDecoder
{
    ...
    private final UpdateOrderDecoder parentMessage = this;
    ...
    public UpdateOrderDecoder wrap(
    ...
    public UpdateOrderDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public UpdateOrderDecoder sbeRewind()
    {
    ...
    public String market()
    {
        ...
        buffer.getBytes(offset + 24, dst, 0, 7);
    ...
    public int getUserId(final byte[] dst, final int dstOffset)
    {
        ...
        buffer.getBytes(offset + 31, dst, dstOffset, length);
    ...
    {
        final byte[] dst = new byte[7];
        buffer.getBytes(offset + 31, dst, 0, 7);
    ...
    {
        final byte[] dst = new byte[7];
        buffer.getBytes(offset + 38, dst, 0, 7);
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[UpdateOrder](sbeTemplateId=");
    ...
    public UpdateOrderDecoder sbeSkip()
    {
        sbeRewind();
