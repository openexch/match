...
public final class UpdateOrderEncoder
{
    ...
    private final UpdateOrderEncoder parentMessage = this;
    ...
    public UpdateOrderEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public UpdateOrderEncoder wrapAndApplyHeader(
    ...
    public UpdateOrderEncoder orderType(final OrderType value)
    {
    ...
    public UpdateOrderEncoder orderSide(final OrderSide value)
    {
    ...
    public UpdateOrderEncoder price(final double value)
    {
    ...
    public UpdateOrderEncoder quantity(final double value)
    {
    ...
    public UpdateOrderEncoder market(final int index, final byte value)
    {
        if (index < 0 || index >= 7)
        {
    ...
    public UpdateOrderEncoder putMarket(final byte[] src, final int srcOffset)
    {
        final int length = 7;
    ...
    public UpdateOrderEncoder market(final String src)
    {
        final int length = 7;
    ...
    public UpdateOrderEncoder userId(final int index, final byte value)
    {
        if (index < 0 || index >= 7)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
        ...
        final int pos = offset + 31 + (index * 1);
        buffer.putByte(pos, value);
    ...
    public UpdateOrderEncoder putUserId(final byte[] src, final int srcOffset)
    {
        final int length = 7;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
        ...
        buffer.putBytes(offset + 31, src, srcOffset, length);

        return this;
    }

    public UpdateOrderEncoder userId(final String src)
    {
        final int length = 7;
        final byte[] bytes = (null == src || src.isEmpty()) ? org.agrona.collections.ArrayUtil.EMPTY_BYTE_ARRAY : src.getBytes(java.nio.charset.StandardCharsets.UTF_8);
        if (bytes.length > length)
        ...
        buffer.putBytes(offset + 31, bytes, 0, bytes.length);

        for (int start = bytes.length; start < length; ++start)
        {
            buffer.putByte(offset + 31 + start, (byte)0);
        }
    ...
    public UpdateOrderEncoder orderId(final int index, final byte value)
    {
        if (index < 0 || index >= 7)
        {
            throw new IndexOutOfBoundsException("index out of range: index=" + index);
    ...
    public UpdateOrderEncoder putOrderId(final byte[] src, final int srcOffset)
    {
        final int length = 7;
        if (srcOffset < 0 || srcOffset > (src.length - length))
        {
    ...
    public UpdateOrderEncoder orderId(final String src)
    {
        final int length = 7;
        final byte[] bytes = (null == src || src.isEmpty()) ? org.agrona.collections.ArrayUtil.EMPTY_BYTE_ARRAY : src.getBytes(java.nio.charset.StandardCharsets.UTF_8);
        if (bytes.length > length)
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final UpdateOrderDecoder decoder = new UpdateOrderDecoder();
